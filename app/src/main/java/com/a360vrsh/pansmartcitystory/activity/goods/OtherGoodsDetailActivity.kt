...
import kotlinx.android.synthetic.main.activity_other_goods_detail.*
import kotlinx.android.synthetic.main.activity_other_goods_detail.ll_bottom_group
 ...
 * 商品详情-其他
 * */
class OtherGoodsDetailActivity : BaseTitleActivity() {
    ...
    private fun goodsDelete() {
        UiUtil.getDialog(this@OtherGoodsDetailActivity, "提示", "确定删除该商品？")
            .setPositive("确定") { v ->
                goodsId?.let {
