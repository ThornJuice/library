 ...
 * 忘记密码ViewModel
 * */
class ForgetPwdViewModel(application: Application) : BaseViewModel(application) {
     ...
     * 提交
     * */
    fun submit(context: Context, phone: String, code: String, isShowLoading: Boolean) {
