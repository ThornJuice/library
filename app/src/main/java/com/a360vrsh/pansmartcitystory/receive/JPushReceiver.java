package com.a360vrsh.pansmartcitystory.receive;
...
import com.a360vrsh.pansmartcitystory.MyApplication;
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                LogUtil.d(TAG, "[MyReceiver] 接收Registration Id : " + JPushInterface.getRegistrationID(context));
    ...
    private void processCustomMessage(Context context, Bundle bundle) {
        ...
        if (extras != null) {
            try {
                ...
                if (json.has("music")) {
                    ...
                    switch (music) {
                        ...
                        case "d":
                            ...
                            soundPool.load(context, R.raw.shopkjl, 1);
                ...
                } else if (json.has("aid")) {//TODO  更新推送消息

//                    EventBus.getDefault().postSticky(new Entity(9, extras));
                }
