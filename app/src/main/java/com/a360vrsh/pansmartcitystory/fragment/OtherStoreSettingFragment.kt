...
import kotlinx.android.synthetic.main.fragment_other_store_setting.*


/**
 * 其他行业店铺设置
 */
class OtherStoreSettingFragment : BaseFragment() {
...
//    private var perCost: String? = null//人均消费
    ...
    companion object {
        private const val TAG = "OtherStoreSettingFragment"

        @JvmStatic
        fun newInstance() =
            OtherStoreSettingFragment().apply {
